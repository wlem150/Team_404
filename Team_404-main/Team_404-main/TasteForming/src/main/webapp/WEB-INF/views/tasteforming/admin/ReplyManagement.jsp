								...
								<table class="jsgrid-table">
									...
									<tr class="jsgrid-header-row">
										...
										<th
											...
											style="width: 130px;">내용</th>
										<th class="jsgrid-header-cell jsgrid-align-center jsgrid-header-sortable"
											style="width: 50px;">등록일자</th>
										<th
											class="jsgrid-header-cell jsgrid-align-center jsgrid-header-sortable"
											style="width: 50px;">수정일자</th>
										<th
							...
							<div class="jsgrid-grid-body">
								<table class="jsgrid-table">
									<tbody>
										...
										<!-- table body edit -->
										<c:forEach items="${reply }" var="rep" varStatus="loop">

											<tr class="jsgrid-edit-row"
												id="edit-row-${loop.index}" style="display: none;">
												<td class="jsgrid-cell" style="width: 50px;"><input
													type="text" value="${rep.resview_No }" readonly></td>
												<td class="jsgrid-cell" style="width: 50px;"><input
													type="text" value="${rep.userId }" readonly></td>

												<td class="jsgrid-cell" style="width: 130px;"><input
													type="text" value="${rep.content }" readonly></td>
												<td class="jsgrid-cell" style="width: 50px;"><input
													type="date" value="${rep.regDate }" readonly></td>
												<td class="jsgrid-cell" style="width: 50px;"><input
													type="date" value="${rep.updateDate }" readonly></td>
												<td
...
<%-- 												<td class="jsgrid-cell jsgrid-align-center" style="width: 50px;"><c:out
														value="${rep.resview_No }" /></td>
												<td class="jsgrid-cell jsgrid-align-center"
													style="width: 50px;"><c:out value="${rep.userId }" /></td>
												<td class="jsgrid-cell jsgrid-align-center"
													style="width: 70px;"><c:out value="${rep.res_no }" /></td>
												<td class="jsgrid-cell jsgrid-align-right" style="width: 130px;"><c:out
														value="${rep.content }" /></td> --%>


												<td class="jsgrid-cell jsgrid-align-center"
													style="width: 50px;"><c:out value="${rep.resview_No }" /></td>
												<td class="jsgrid-cell jsgrid-align-center"
													style="width: 50px;"><c:out value="${rep.userId }" /></td>
												<td class="jsgrid-cell jsgrid-align-center"
													style="width: 130px;"><c:out value="${rep.content }" /></td>
												<td class="jsgrid-cell jsgrid-align-center" style="width: 50px;">
												<fmt:formatDate value="${rep.regDate}" pattern="yyyy-MM-dd" /></td>
												<td class="jsgrid-cell jsgrid-align-center" style="width: 50px;">
												<fmt:formatDate value="${rep.regDate}" pattern="yyyy-MM-dd" /></td>
												<td
													class="jsgrid-cell jsgrid-control-field jsgrid-align-center"
							...
							<form action="/tasteforming/admin/ReplyManagement" id="actionForm"
								method='get'>
