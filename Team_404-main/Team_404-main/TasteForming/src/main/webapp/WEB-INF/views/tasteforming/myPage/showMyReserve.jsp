...
<body class="hold-transition sidebar-mini">
    ...
    font-weight: bold;">신청한예약</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">신청한예약</li>
							</ol>
						</div>
					</div>
				</div>
			...
			<section class="content">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">내가 신청한 예약</h3>
					</div>
					<!-- /.card-header -->
					<div class="card-body">
										...
										<c:forEach items="${reserve }" var="reserve" varStatus="loop">
											...
											<tr
												...
												<td
													...
													style="width: 50px;">
													<c:choose>
														<c:when test="${reserve.confirm == false && reserve.cancel_Date == null}">
															확인중입니다.
														</c:when>
														<c:when test="${reserve.confirm == true }">
															<img src="${path}/resources/img/done.png" alt="일반유저"
																style="vertical-align: initial;">
														</c:when>
														<c:otherwise>
															<img src="${path}/resources/img/cross.png" alt="일반유저"
																style="vertical-align: initial;">
														</c:otherwise>
													</c:choose>
