...
<link rel="stylesheet"
	...
	integrity="sha512-SJPPRkjqfDUIKj7G+wpnzO/ZKdcR1T29/HTJpTILhYX4HfwN3q4q1wJgkm2A8F6ax+Q/pdnKv55ayZtxD9Yl6w=="
	crossorigin="anonymous" referrerpolicy="no-referrer" />

<!-- Bootstrap JavaScript -->
<script
	src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.3.2/js/bootstrap.min.js"
	integrity="sha512-XHzlT0TgJZcLgW8Y13zjKq3q4Ty1hJQcyehgLUczi7q3rHv1V70N93X9fJ/ttC1zDjK+s7D+G/5+xn45mP5GvA=="
...
<body class="hold-transition sidebar-mini">
    ...
    font-weight: bold;">Reservation</h1>
					</div>
					<div class="col-sm-6">
